 ...
 */
function build(registry: AgentSurfaceRegistry, scope: readonly Scope[]): AgentToolset {
 ...
 */
export function getHostToolset(pathname: string = currentPathname()): AgentToolset {
